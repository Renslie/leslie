...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-create"><a href="#" class="btn btn-primary langse" data-toggle="modal" data-target="#myDialog" data-data="add"><i class="glyphicon glyphicon-plus-sign"></i><span>添加角色</span></a></div>
            <div class="box-content"  data-list="<?= Url::toRoute('admin/rolelist') ?>" data-del="<?= Url::toRoute('admin/roledel') ?>" data-permission="<?= Url::toRoute('admin/getpermissionsbyrole') ?>">
...
<div class="modal fade" id="myDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        $form = ActiveForm::begin([
                    'id' => 'edit-form',
                    'action' => Url::toRoute('admin/roleedit'),
